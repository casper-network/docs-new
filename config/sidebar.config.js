...
module.exports = {
    ...
    developers: [
        ...
        "developers/prerequisites",
        {
            ...
            collapsed: true,
            items: [
                "developers/writing-contracts/index",
                "developers/writing-contracts/prerequisites",
                "developers/writing-contracts/getting-started",
                "developers/writing-contracts/simple-contract",
                "developers/writing-contracts/testing-contracts",
                "developers/writing-contracts/contracts-and-session-code",
                "developers/writing-contracts/writing-session-code",
                "developers/writing-contracts/testing-session-code",
                "developers/writing-contracts/best-practices",
            ],
        },
        {
            type: "category",
            ...
            items: [
                ...
                {
                    type: "category",
                    label: "Transactional JSON-RPC Method",
                    collapsible: true,
                    collapsed: true,
                    items: ["developers/json-rpc/json-rpc-transactional", "developers/json-rpc/json-rpc-transactional-out"],
                },
            ...
            items: [
                "developers/cli/index",
                {
                    ...
                    items: [
                        ...
                        "developers/cli/transfers/workflow",
                        "developers/cli/transfers/deploy",
                        "developers/cli/transfers/verify",
                    ],
                },
    ...
    operators: [
        "operators/index",
        {
            ...
            collapsible: true,
            collapsed: true,
            items: ["operators/hardware", "operators/setup"],
        },
        {
            type: "category",
            ...
            collapsed: true,
            items: [
                "operators/development-prerequisites",
                "operators/create-public",
                "operators/create",
                "operators/staging-files-network",
                "operators/querying-network",
            ],
        },
        {
            type: "category",
            ...
            collapsible: true,
            collapsed: true,
            items: ["operators/install-node", "operators/joining", "operators/bonding", "operators/unbonding", "operators/upgrade"],
        },
    ],
    design: [
        "design/index",
