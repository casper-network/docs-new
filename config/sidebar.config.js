...
module.exports = {
    ...
    operators: [
        "operators/index",
        {
            ...
            collapsible: true,
            collapsed: true,
            items: ["operators/setup/hardware", "operators/setup/basic-node-configuration"],
        },
        {
            type: "category",
        ...
        },
        {
            ...
            items: [
                ...
                "operators/becoming-a-validator/upgrade",
            ],
        },
    ],
    design: [
