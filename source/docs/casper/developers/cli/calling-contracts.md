...
- You know how to [install contracts and query global state](/developers/cli/installing-contracts.md) using the [default Casper client](/dapp-dev-guide/setup#the-casper-command-line-client)
