...
* `main_purse_under_public_key` The main purse under a provided [`PublicKey`](/developers/json-rpc/types_chain#publickey).

* `main_purse_under_account_hash` The main purse under a provided [`AccountHash`](/developers/json-rpc/types_chain#accounthash).

* `purse_uref` A specific purse identified by the associated [`URef`](/developers/json-rpc/types_chain#uref).
