...
This method returns the JSON representation of a [Block](/concepts/design/casper-design/#block-structure-head) from the network.

|Parameter|Type|Description|
|---------|----|-----------| 
|[block_identifier](/developers/json-rpc/types_chain#blockidentifier)|Object|The Block hash or the Block height.|
...
|[block](/developers/json-rpc/types_chain#jsonblock)|Object|The Block, if found. (Not required)|
...
This method returns all native transfers within a given [Block](/concepts/design/casper-design/#block-structure-head) from a network.

|Parameter|Type|Description|
|---------|----|-----------| 
|[block_identifier](/developers/json-rpc/types_chain#blockidentifier)|Object|The Block hash.|
...
|---------|----|-----------| 
|api_version|String|The RPC API version.|
|[block_hash](/developers/json-rpc/types_chain#blockhash)|Object|The Block hash, if found.|
|[transfers](/developers/json-rpc/types_chain#transfer)|Array|The Block's transfers, if found.|
...
|Parameter|Type|Description|
|---------|----|-----------|
|[block_identifier](/developers/json-rpc/types_chain#blockidentifier)|Object|The Block hash. (Optional)|
...
|---------|----|-----------|
|api_version|String|The RPC API version.|
|[state_root_hash](/developers/json-rpc/types_chain#digest)|String| Hex-encoded hash of the state root.|
...
This method retrieves a [Deploy](/concepts/deploy-and-deploy-lifecycle.md#execution-semantics-deploys) from a network. It requires a `deploy_hash` to query the Deploy.

|Parameter|Type|Description|
|---------|----|-----------|
|[deploy_hash](/developers/json-rpc/types_chain#deployhash)|String|The Deploy hash.|
...
|---------|----|-----------|    
|api_version|String|The RPC API version.|
|[deploy](/developers/json-rpc/types_chain#deploy)|Object|The Deploy.|
|[execution_results](/developers/json-rpc/types_chain#jsonexecutionresult)|Object|The map of Block hash to execution result.|
...
|Parameter|Type|Description|
|---------|----|-----------|   
|[state_identifier](/developers/json-rpc/types_chain#globalstateidentifier)|Object|The identifier used for the query.|
...
|---------|----|-----------|     
|api_version|String|The RPC API version.|
|[block_header](/developers/json-rpc/types_chain#jsonblockheader)|Object|The Block header if a Block hash was provided. (Not required)|
|[stored_value](/developers/json-rpc/types_chain#storedvalue)|Object|The stored value.|
|[merkle_proof](/developers/json-rpc/types_chain#merkle-proof)|String|The merkle proof.|
...
|Parameter|Type|Description|
|---------|----|-----------|
|[public_key](/developers/json-rpc/types_chain#publickey)|String|The public key of the Account.|
|[block_identifier](/developers/json-rpc/types_chain#blockidentifier)|Object|The Block identifier.|
...
|---------|----|-----------|    
|api_version|String|The RPC API version.|
|[account](/developers/json-rpc/types_chain#account)|Object|A JSON representation of the Account structure.| 
|[merkle_proof](/developers/json-rpc/types_chain#merkleproof)|String|The merkle proof.|
...
|Parameter|Type|Description|
|---------|----|-----------|
|[state_root_hash](/developers/json-rpc/types_chain#digest)|String|The hash of state root.|
...
|---------|----|-----------|
|api_version|String|The RPC API version.|
|[balance_value](/developers/json-rpc/types_chain#u512)|String|The balance value in motes.|
|[merkle_proof](/developers/json-rpc/types_chain#merkle-proof)|String|The merkle proof.|
...
|Parameter|Type|Description|
|---------|----|-----------|
|[state_root_hash](/developers/json-rpc/types_chain#digest)|String|Hash of the state root.|
|[dictionary_identifier](/developers/json-rpc/types_chain#dictionaryidentifier)|Object|The Dictionary query identifier.|
...
|---------|----|-----------| 
|api_version|String|The RPC API version.|
|[peers](/developers/json-rpc/types_chain#peersmap)|Array|The node ID and network address of each connected peer.|
...
|[last_added_block_info](/developers/json-rpc/types_chain#minimalblockinfo)|Object|The minimal info of the last Block from the linear chain.|
|[next_upgrade](/developers/json-rpc/types_chain#nextupgrade)|Object|Information about the next scheduled upgrade.|
|[our_public_signing_key](/developers/json-rpc/types_chain#publickey)|String|Our public signing key.|
|[peers](/developers/json-rpc/types_chain#peersmap)|Array|The node ID and network address of each connected peer.|
|[round_length](/developers/json-rpc/types_chain#timediff)|Integer|The next round length if this node is a validator. A round length is the amount of time it takes to reach consensus on proposing a Block.|
|[starting_state_root_hash](/developers/json-rpc/types_chain#digest)|String|The state root hash used at the start of the current session.|
|[uptime](/developers/json-rpc/types_chain#timediff)|Integer|Time that passed since the node has started.|
