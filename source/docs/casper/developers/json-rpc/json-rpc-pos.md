...
This method returns the [bids](/concepts/economics/consensus.md#bids) and [validators](/glossary/V.md#validator) as of either a specific Block (by height or hash). If you do not provide a  `block_identifier`, `state_get_auction_info` will return information from the most recent Block.
...
|[auction_state](/developers/json-rpc/types_chain#auctionstate)|Object|The auction state.|
...
|---------|----|-----------| 
|api_version|String|The RPC API version.|
|[changes](/developers/json-rpc/types_chain#jsonvalidatorchanges)|Object|The validators' status changes.|
...
|Parameter|Type|Description|
|---------|----|-----------| 
|[block_identifier](/developers/json-rpc/types_chain#blockidentifier)|Object|The Block identifier. If you do not supply a `block_identifier`, the returned information will be the most recent Block. (Optional)|
...
|---------|----|-----------|
|api_version|String|The RPC API version.|
|[era_summary](/developers/json-rpc/types_chain#erasummary)|Object|The era summary (If found).|
