...
If your test configuration matches your production [chainspec](/glossary/C/#chainspec), you can check the deploy status and roughly see how much it would cost. You can estimate the costs in this way and then add a small buffer to be sure. Refer to the [runtime economics](/concepts/economics/runtime.md#gas-allocation) section for more details about gas usage and fees.
