...
Before building the smart contract for this tutorial, you need to [install Rust](/developers/writing-contracts/getting-started.md) and [set up the development environment](/developers/writing-contracts/getting-started.md#development-environment-setup).
