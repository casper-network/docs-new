...
On Testnet, you can fund an account by requesting test tokens according to [this guide](/users/testnet-faucet/). You can request test tokens **only once** for each account.
