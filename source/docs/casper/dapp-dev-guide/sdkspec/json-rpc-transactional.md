...
|---------|----|-----------|
|[deploy](/dapp-dev-guide/sdkspec/types_chain.md#deploy)|Object|A Deploy consists of an item containing a smart contract along with the requester's signature(s).|
...
The result contains the [deploy_hash](/dapp-dev-guide/sdkspec/types_chain.md#deployhash), which is the primary identifier of a Deploy within a Casper network.

|Parameter|Type|Description|
|---------|----|-----------|
|api_version|String|The RPC API version.|
|[deploy_hash](/dapp-dev-guide/sdkspec/types_chain.md#deployhash)|String| A hex-encoded hash of the Deploy as sent.|
...
|Parameter|Type|Description|
|---------|----|-----------|
|[block_identifier](/dapp-dev-guide/sdkspec/types_chain.md#blockidentifier)|Object|The block hash or height on top of which to execute the deploy. If not supplied,the most recent block will be used.|
|[deploy](/dapp-dev-guide/sdkspec/types_chain.md#deploy)|Object|A Deploy consists of an item containing a smart contract along with the requester's signature(s).|
...
|---------|----|-----------|
|api_version|String|The RPC API version.|
|[block_hash](/dapp-dev-guide/sdkspec/types_chain.md#blockhash)|Object|The Block hash on top of which the deploy was executed.|
|[execution_results](/dapp-dev-guide/sdkspec/types_chain.md#executionresult)|Object|The map of Block hash to execution result.|