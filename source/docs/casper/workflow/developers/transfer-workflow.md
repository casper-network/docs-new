...
Refer to the Section on [querying deploys](/workflow/developers/querying.md#querying-deploys) within the network to check the execution status of the transfer.
