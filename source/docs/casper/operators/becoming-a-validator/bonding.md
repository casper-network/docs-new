...
3. Install the [Rust casper-client](/developers/prerequisites/#the-casper-command-line-client) and fund the [keys](/operators/setup/basic-node-configuration#create-fund-keys) you will use for bonding 
