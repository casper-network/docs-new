...
The [Prerequisites](/developers/prerequisites/#the-casper-command-line-client) page lists installation instructions for the Casper client, which is useful for generating keys and retrieving information from the network.
...
To submit a bonding request, you will need to [fund your account](/developers/prerequisites/#fund-your-account) as well.
