...
This guide assumes that you have previously delegated tokens] to a validator using a [block explorer](/workflow/users/delegate-ui) or the [Casper client](/developers/cli/delegate).
