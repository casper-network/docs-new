...
2. You need to [fund the account's main purse](/users/funding-from-exchanges) to delegate tokens.
...
If you want to undelegate your tokens, you can do so at any time. See the [Undelegation Guide](/users/undelegate-ui) for details.
