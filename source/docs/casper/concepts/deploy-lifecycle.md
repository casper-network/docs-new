...
-   a 32-byte identifier representing the [hash](/source/docs/casper/design/serialization-standard.md#serialization-standard-hash-key) where a contract is already stored in the global state
