...
- You should be familiar with [writing smart contracts](../../developers/writing-onchain-code/simple-contract.md), [on-chain contracts](../../developers/cli/sending-deploys.md), and [calling contracts](../../developers/cli/calling-contracts.md) on a Casper network.
