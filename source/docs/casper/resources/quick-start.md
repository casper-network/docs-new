...
6. Install the [Casper client](/developers/prerequisites/#the-casper-command-line-client): 
...
8. Set up a [Casper Account](/developers/prerequisites/#setting-up-an-account).
