...
1.  You have completed the [Getting Started section](/developers/writing-contracts/getting-started.md), which shows you how to install your development environment, including tools like _CMake_ (version 3.1.4+), _Cargo_, and _Rust_.
